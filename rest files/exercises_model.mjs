 ...
 * @param {Number} limit
 * @returms A promise.  Resolves to the JavaScript object matching the query.
 */
 ...
 * @param {String} _id
 * @returns A promise.  Resolves to the JavaScript object matching the query.
 */
...
/**
 * Replace the name, reps, and weight properties of the exercise with the id value provided.
 * @param {String} _id
 * @param {String} name
 * @param {Number} reps
 * @param {Number} weight
...
/**
 * Delete a exercise given an ID value
 * @param {String} _id
 * @returns A promise.  Resolves to remove the JavaScript object from the database.
 */
